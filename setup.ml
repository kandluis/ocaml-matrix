...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4d82987bfd32c69433d62e058494b017) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("ocaml-matrix", OCamlbuildDocPlugin.doc_build "src")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("ocaml-matrix", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["kandluis (https://github.com/kandluis)"];
          homepage = None;
          synopsis =
            "Complete matrix library for Ocaml, with the ability to execute\nthe simplex algorithm";
          description = None;
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "NT\000\143eë³ñ\018Á\152ÃÕ»n\011";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
